                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="card card-body">
                                                <form action="{{route('categories.update', $data->id)}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <img style="padding:4px;border:1px solid gray;" width="250" id="showImage" class="mt-2 img-fluid mb-3" src="{{url($data->image)}}" alt="User profile picture"><br>

                                                    <label>Description</label>
                                                    <textarea class="form-control mb-3" placeholder="Enter description" name="description">{{$data->description}}</textarea>
